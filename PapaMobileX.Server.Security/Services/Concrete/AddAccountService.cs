...
public class AddAccountService : IAddAccountService
{
    ...
    public AddAccountService(AccountsRepository accountsRepository,
    ...
    public async Task<Result<AddAccountError>> AddAccount(NewAccountModel newAccountModel)
    {
        ...
        string hashedPassword = _hashService.GetHash(newAccountModel.Password, salt);
    ...
    {
        Account? existingAccount = await _accountsRepository.GetAccountByUserName(userName);
